...
//		$pieces[] = Html::element( 'p', null, 'breakpoint1' ); // WL
		$pieces[] = $this->getRlClient()->getHeadHtml();

// WL dropdown becomes normal after disable buildExemptModules()
  		$pieces[] = $this->buildExemptModules();
		
//		$pieces[] = Html::element( 'p', null, 'breakpoint2' ); // WL
	...
	public function getHeadLinksArray() {
		...
		# Language variants
		if ( !$config->get( 'DisableLangConversion' ) ) { // WL: add && to make the if statment false
