...
// WL
	...
	protected function getMainNavigation() {
		...
		$html = $this->getSidebarChunk( 'site-navigation', 'navigation', $html );	// WL
...
// WL
	...
	protected function getAfterContent() {
		...
		if ( $this->data['catlinks'] || $this->data['dataAfterContent'] ) {
			$html .= Html::openElement( 'div', [ 'id' => 'content-bottom-s' ] );
...
// WL
	...
	protected function getCategories() {
		...
		if ( $catList ) {
			$html = $this->getSidebarChunk( 'catlinks-sidebar', $catHeader, $catList );	// WL
		}
